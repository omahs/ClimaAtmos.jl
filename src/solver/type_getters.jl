...
function get_atmos(config::AtmosConfig, params)
    ...
    vert_diff = get_vertical_diffusion_model(diffuse_momentum, parsed_args, params, FT)
    atmos = AtmosModel(;
        moisture_model,
        model_config,
        ...
        vert_diff,
        viscous_sponge = get_viscous_sponge_model(parsed_args, sponge_params, FT),
        rayleigh_sponge = get_rayleigh_sponge_model(parsed_args, sponge_params, FT),
