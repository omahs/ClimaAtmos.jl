...
struct AtmosDomain
    ...
    # TODO: type is here only for compatibility with the non-orographic gravity wave
...
# The face_space of a given center_space is just a different view, so let's
# provide a getter that returns that on the fly
